              ...
              body: Container(
                ...
                child: Column(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          AppText(text: bibleStudyList[bbIndex].date, size: 25,)
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: Column(
                        children: [
                          AppLargeText(text: bibleStudyList[bbIndex].topic, color: Color.fromARGB(255, 0, 8, 116),),
                          AppText(text: bibleStudyList[bbIndex].theme, size: 20,)
                        ],
                      ),
                    ),
                    Expanded(
                  ...
                  Container(
                   ...
                   width: double.maxFinite,
                  child: IconButton(
                    icon: Icon(Icons.back_hand, color: AppColors.mainColor,), onPressed: () { Navigator.pop(context); },
                  ),
                  )
                  ],
                ),
